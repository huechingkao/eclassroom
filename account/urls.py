...
urlpatterns = [
    ...
    path('point/<int:pk>', views.PointList.as_view()), 
    path('questionary/<int:user_id>/create/', views.QuestionaryCreate.as_view()),
    path('questionary/<int:pk>/update/', views.QuestionaryUpdate.as_view()), 
 ]